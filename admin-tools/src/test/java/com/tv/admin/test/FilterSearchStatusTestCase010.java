...
public class FilterSearchStatusTestCase010 extends BaseClass {

	public static Logger log = LogManager.getLogger(BaseClass.class.getName());
	LoginPage loginPage;
	FilterPage filterPage;
	TestUtil testUtil;
	String sheetName = "SearchStatus";

	public FilterSearchStatusTestCase010() {
		super();
	}
	...
	public void filterSearchStatusValidation(String title, String sku, String description) {
		...
		log.info("Starting Search Status Validation");
		filterPage.searchStatus(title, sku, description);
		log.info("validation of Search Status is successful");
