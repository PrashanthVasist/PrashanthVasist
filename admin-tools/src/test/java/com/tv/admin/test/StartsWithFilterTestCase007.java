...
public class StartsWithFilterTestCase007 extends BaseClass {

	public static Logger log = LogManager.getLogger(BaseClass.class.getName());
	LoginPage loginPage;
	FilterPage filterPage;
	TestUtil testUtil;
	String sheetName = "StartsWithFilter";

	public StartsWithFilterTestCase007() {
		super();
	}
	...
	public void startsWithFilterValidation(String dropdown, String description) {
		...
		log.info("Starting Starts With Filter Validation");
		filterPage.startsWithFilter(dropdown, description);
		log.info("validation of Starts With Filter is successful");
