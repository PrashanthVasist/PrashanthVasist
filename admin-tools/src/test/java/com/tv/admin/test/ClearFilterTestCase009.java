...
public class ClearFilterTestCase009 extends BaseClass {
	...
	TestUtil testUtil;
	String sheetName = "ClearFIlter";

	public ClearFilterTestCase009() {
		super();
	}
	...
	public void clearFilterValidation(String title, String sku, String description) {
		...
		log.info("Starting Clear Filter Validation");
		filterPage.clearFilter(title, sku, description);
		log.info("validation of Clear Filter is successful");
